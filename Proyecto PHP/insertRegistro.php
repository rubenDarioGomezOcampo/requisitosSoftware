...
<body>
    ...
    <div class="form">
        ...
        if (
            ...
            $sql = "INSERT INTO `users` (`id`, `userName`, `email`, `document`, `userPassword`, `login_date`, `update_date`) VALUES (NULL, '$userName', '$userMail', '$userId', '$encriptada', current_timestamp(), NULL)";
