...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Dario Web</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="formularioRegistro.php">Registrar Usuario</a></li>
            <li><a class="dropdown-item" href="consultarUsuarioGeneral.php">Consultar Usuarios</a></li>
