...
<body>
    <div class="container">
        ...
        <form action="procesaUsuario.php" method="post" onsubmit="return validar()">
            ...
            <input class="form-control" type="text" name="nombreUsuarioSolicitado" />
            
            <labe class="form-label">Mail del usuario</labe>
            <input class="form-control" type="mail" name="mailUsuarioSolicitado" />
            
            <labe class="form-label">Nro de Documento del usuario</labe>
            <input class="form-control" type="number" name="documentoUsuarioSolicitado" />
            
            <labe class="form-label">Contraseña del Usuario</labe>
            <input class="form-control" type="password" name="passwordUsuarioSolicitado" />
